            ...
            <div className='main-cont'>
                <div className='child left-cont'>
                    <div className='greet-cont'>
                        ...
                        <p className='desc-text'>Мы рады что вы решили присоединиться к нашей платформе бронирования
                            билбордов.</p><br/>
                    </div>
                </div>
                ...
                <div className='child right-cont'>
                    ...
                    <div className='form-input'>
                        <form ref={form}>
                            <input ref={email} name='email' className='input-field' placeholder='Email' type='email'
                                   required/>
                            <input ref={name} name='username' className='input-field' placeholder='Name' type='text'
                                   required/>
                            <input ref={password} name='password' className='input-field' placeholder='Password'
                                   type='password' required/>
                            <input ref={confirmPassword} name='password-valid' className='input-field'
                                   placeholder='Reenter Password' type='password' required/>
