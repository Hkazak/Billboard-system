            ...
            <div className='main-cont'>
                <div className='child left-cont'>
                    <div className='greet-cont'>
                        ...
                        <p className='desc-text'>Если у вас все еще есть доступ к своей почте, мы сможем отправить вам
                            код подтверждения для того чтобы вы смогли создать новый пароль.</p><br/>
                        <p className='desc-text'>Если вы потеряли доступ к своей электронной почте, пожалуйста свяжитесь
                            со своим ответственным менеджером по заказу, либо по номеру +770012345678!</p>
                    </div>
                </div>
