            ...
            <div className='main-cont'>
                ...
                <div className='child right-cont'>
                    ...
                    <div className='form-input'>
                        <form>
                            <input ref={code} name='verification-code' className='input-field' placeholder='Код'
                                   type='text' required/>
                            <input ref={newPassword} name='new_password' className='input-field'
                                   placeholder='Новый пароль' type='password' required/>
                            <input ref={newPasswordConfirm} name='new_password_val' className='input-field'
                                   placeholder='Подтверждение пароля' type='password' required/>
