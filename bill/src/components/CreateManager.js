...
function CreateManager({hide, setHide, handleNewManager}) {
    ...
    return (
        <form className="create-manager-block" hidden={hide}>
            ...
            <input required placeholder="Фамилия" type="text" className="manager-data-input"
                   onChange={e => setLastName(e.target.value)}/>
            <input required placeholder="Имя" type="text" className="manager-data-input"
                   onChange={e => setFirstName(e.target.value)}/>
            <input required placeholder="Отчество" type="text" className="manager-data-input"
                   onChange={e => setMiddleName(e.target.value)}/>
            <input required placeholder="E-mail" type="email" className="manager-data-input"
                   onChange={e => setEmail(e.target.value)}/>
            <input required placeholder="Моб. телефон" type="text" className="manager-data-input"
