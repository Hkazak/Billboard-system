...
function CreateTariff({isEnabled, setIsEnabled, handleNewTariff, setPage}) {
    ...
    return (
        <form className="new-tariff" hidden={!isEnabled}>
            ...
            <input required type="text" placeholder="Название*" name="tariffName" className="tariff-property"
                   onChange={tariffNameChanged}/>
            <input required type="number" placeholder="Цена*" name="tariffPrice" className="tariff-property"
                   onChange={tariffPriceChanged}/>
            ...
            <div className="select-time-period">
                <input type="time" name="tariffTimeStart" className="time-period" value={timeStart}
                       onChange={tariffTimeStartChanged}/>
                <input type="time" name="tariffTimeEnd" className="time-period" value={timeEnd}
                       onChange={tariffTimeEndChanged}/>
            </div>
